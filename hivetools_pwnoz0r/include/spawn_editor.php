...
$db->query("INSERT INTO `object_spawns` ( `ObjectUID`, `Classname`, `Worldspace`,`Inventory` ) VALUES( '".$addObject."', '".$addClassName."', '".$addWorldSpace."','[]')");
 }
...
$db->query("UPDATE `object_classes` SET  `Chance`='".$Chance."', `MaxNum`='".$MaxNum."', `Damage`='".$Damage."' WHERE `Classname`='".$Classname."'");
}
...
$db->query("INSERT INTO `object_classes` ( `Classname`, `Chance`,  `MaxNum`, `Damage` ) VALUES( '".$Classname."', '0.70', '1', '0')");
}
