...
$db->query("DELETE FROM `Object_DATA` WHERE 
`Classname` = 'TrapBear' AND DATE(Datestamp) < CURDATE() - INTERVAL 5 DAY AND `Instance` = '".$DZ_INSTANCE."'
OR
`Classname` = 'Wire_cat1' AND DATE(Datestamp) < CURDATE() - INTERVAL 3 DAY AND `Instance` = '".$DZ_INSTANCE."'
OR
`Classname` = 'Hedgehog_DZ' AND DATE(Datestamp) < CURDATE() - INTERVAL 4 AND `Instance` = '".$DZ_INSTANCE."'
OR
`Classname` = 'Sandbag1_DZ' AND DATE(Datestamp) < CURDATE() - INTERVAL 8 DAY AND `Instance` = '".$DZ_INSTANCE."'
");
...
$db->query("DELETE FROM `Object_DATA` WHERE 
`CharacterID`='".$row['CharacterID']."' AND `Classname`  = 'TentStorage' AND `Instance` = '".$DZ_INSTANCE."' AND DATE(Datestamp) < CURDATE() - INTERVAL 8 DAY");
}
...
$db->query("DELETE FROM `Object_DATA` WHERE `Instance` = '".$DZ_INSTANCE."' AND DATE(Datestamp) < CURDATE() - INTERVAL 8 DAY");
